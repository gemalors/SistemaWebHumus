...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "" + ({"11":"vendor","12":"main"}[chunkId]||chunkId) + "-chunk.1660946356889.js";
...
/******/ 	__webpack_require__.p = "https://df5kbf1hky40.cloudfront.net/static/angular_bundle/";
/******/
...
var IE8_DOM_DEFINE = __webpack_require__(209);
...
if (__webpack_require__(18)) {
  ...
  var ArrayIterators = __webpack_require__(228);
...
var isObject = __webpack_require__(8);
var setPrototypeOf = __webpack_require__(152).set;
...
function patchEventTarget(_global, apis, patchOptions) {
    ...
    var globalZoneAwareCallback = function 
Ç(event) {
        // https://github.com/angular/zone.js/issues/911, in IE, sometimes
        // event will be undefined, so we need to use window.event
        event = event || _global.event;
...
module.exports = __webpack_require__(86)('native-function-to-string', Function.toString);
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(33)(proto, TO_PRIMITIVE, __webpack_require__(416));
...
var $export = __webpack_require__(1);
var log1p = __webpack_require__(215);
var sqrt = Math.sqrt;
...
$export($export.S, 'Math', { fround: __webpack_require__(419) });
...
var $export = __webpack_require__(1);
var toInteger = __webpack_require__(42);
var aNumberValue = __webpack_require__(202);
...
$export($export.S + $export.F * !__webpack_require__(18), 'Object', { defineProperties: __webpack_require__(218) });
...
var microtask = __webpack_require__(420)();
var newPromiseCapabilityModule = __webpack_require__(216);
var perform = __webpack_require__(422);
var userAgent = __webpack_require__(424);
var promiseResolve = __webpack_require__(423);
var PROMISE = 'Promise';
var TypeError = global.TypeError;
var process = global.process;
...
var $export = __webpack_require__(1);
var setProto = __webpack_require__(152);
...
// @@match logic
__webpack_require__(105)('match', 1, function (defined, MATCH, $match, maybeCallNative) {
  return [
...
// @@replace logic
__webpack_require__(105)('replace', 2, function (defined, REPLACE, $replace, maybeCallNative) {
  return [
...
var anObject = __webpack_require__(4);
var sameValue = __webpack_require__(223);
var regExpExec = __webpack_require__(110);

// @@search logic
__webpack_require__(105)('search', 1, function (defined, SEARCH, $search, maybeCallNative) {
  return [
...
// @@split logic
__webpack_require__(105)('split', 2, function (defined, SPLIT, $split, maybeCallNative) {
  var internalSplit;
  if (
    'abbc'[$SPLIT](/(b)*/)[1] == 'c' ||
...
var wks = __webpack_require__(13);
var wksExt = __webpack_require__(227);
var wksDefine = __webpack_require__(425);
...
__webpack_require__(104)(WEAK_SET, function (get) {
